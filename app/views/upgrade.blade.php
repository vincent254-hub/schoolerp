    ...
    <div class="form-box" id="login-box">
        ...
        <form action="{{ URL::to('/upgrade') }}" method="post">
            ...
            <div class="body bg-gray">
                ...
                @if ($currStep == 'welcome')
                    <center>Thank you for choosing Phoenix for your school administration.
                        <br />
                        Please login with administrator account to start Phoenix upgrade
                    </center>
                ...
                @if ($currStep == '3')
                    <div class="form-group">
                        <center><b>Thank You for upgrading Phoenix</b></center>
                    </div>
                    <a href="<?php echo URL::to('/'); ?>" class="btn bg-olive btn-block">Start using Phoenix</a>
                @endif
            </div>
            <div class="footer">
                <a href="/" target="_BLANK" class="btn bg-olive btn-block">Home</a>
            </div>
        </form>
    </div>
