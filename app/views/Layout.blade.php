...
<body class="skin-<?php echo $panelInit->settingsArray['layoutColor']; ?> fixed" ng-app="schoex" ng-controller="mainController">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <aside class="left-side sidebar-offcanvas">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    <?php
                    while ([$key, $value] = each($panelInit->panelItems)) {
                        ...
                        if (isset($value['children'])) {
                            ...
                            while ([$key2, $value2] = each($value['children'])) {
        ...
        <div class="pull-right footerCopyRight" style='margin:20px;'><?php echo $panelInit->settingsArray['footer']; ?> - <a target="_BLANK"
                href="{{ URL::to('/terms') }}"><?php echo $panelInit->language['schoolTerms']; ?></a></div>
    </div>
